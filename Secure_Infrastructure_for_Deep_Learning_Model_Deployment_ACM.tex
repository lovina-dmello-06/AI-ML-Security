...
%%
%% For two-column preview format (currently 29 pages)
\documentclass[acmtog]{acmart}

%% Alternative: For submission with reviewer line numbers (single-column for review)
%% \documentclass[manuscript,screen,review]{acmart}

%% Alternative: For final ACM CSUR single-column format
...
\author{Blaise Dmello}
\email{blaisedmello2002@gmail.com}
\affiliation{%
